...
For running the augmented MNIST dataset with single augmentations, set aug_array = i and run the following code:

python mnist_classification_hypothesis_testing.py --epochs 10 --aug-array-id i --train-size 10000 --test-size 1000
...
python mnist_classification_hypothesis_testing.py --epochs 10 --aug-array-id i --train-size 10000 --test-size 1000 --multiple-augmentations
